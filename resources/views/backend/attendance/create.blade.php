               ...
               <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                     <h4>
                        ...
                        <a href="{{route('attendance.index')}}" class="btn btn-primary float-sm-right"> <i class="fas fa-list"></i>Employee Attendance List</a>
                     </h4>
                  </ol>
               </div>
            </div>
       ...
       <tr id="div {{$employee->id}}" class="text-center">
          ...
          <td colspan="3">
             <div class="switch-toggle switch-3 switch-candy">
                <input class="present" id="present{{$key}}" name="attand_status{{$key}}" value="present" type="radio" checked="checked">

                <label for="present{{$key}}">Present</label>
                <input class="leave" id="leave{{$key}}" name="attand_status{{$key}}" value="Leave" type="radio">

                <label for="leave{{$key}}">Leave</label>
                <input class="absent" id="absent{{$key}}" name="attand_status{{$key}}" value="Absent" type="radio">
