                            ...
                            <div class="row mt-3">
                                <div class="col-sm-6">
                                    ...
                                    <address>
                                        ...
                                        <abbr title="Phone">Shope Name:</abbr> {{$customer->shopname}}<br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="float-end">
                                        ...
                                        <p><b>Vat (21%):</b> <span class="float-end"> &nbsp;&nbsp;&nbsp;{{Cart::tax()}}</span>
                                        </p>
                                        <h3>{{Cart::total()}}</h3>
                                    </div>
                    ...
                    <form class="px-3" action="{{route('final.invoice')}}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="payment_status" class="form-select" id="example-select">
                                <option selected disabled>Select Paymen</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="test" name="pay" required=""
                                placeholder="Pay Now">
                        </div>
                        <input type="hidden" name="customer_id" value="{{$customer->id}}">
                        <input type="hidden" name="order_date" value="{{date('d-F-Y')}}">
                        <input type="hidden" name="order_status" value="pendding">
