    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-xl-12">
                ...
                <form method="POST" action="{{route('update.employ',['id'=>$costomer->id])}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" value="{{$costomer->name}}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" value="{{$costomer->email}}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="phone" value="{{$costomer->phone}}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="address" value="{{$costomer->address}}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="shopname" value="{{$costomer->shopname}}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="account_holder" value="{{$costomer->account_holder}}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="account_number" value="{{$costomer->account_number}}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="bank_name" value="{{$costomer->bank_name}}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="bank_branch" value="{{$costomer->bank_branch}}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="city" value="{{$costomer->city}}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="file" name="image" value="{{$costomer->image}}"
                       ...
                       <div class="mb-3">
                            ...
                            <img id="showImage" src="{{ asset($costomer->image) }}"
